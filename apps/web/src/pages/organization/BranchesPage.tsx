...
import { useBranches } from '../../hooks/organization/useOrganization';
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Branches</h1>
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
              {branches?.data?.length === 0 ? (
                ...
                branches?.data?.map((branch: any) => (
                  <tr key={branch.id} className="hover:bg-slate-50 dark:hover:bg-slate-950 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-slate-500">{branch.code || 'No code'}</div>
                        </div>
                      </div>
                    </td>
