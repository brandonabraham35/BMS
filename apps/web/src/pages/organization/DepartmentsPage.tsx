...
import { useDepartments } from '../../hooks/organization/useOrganization';
import { Plus, Search, Users2, MoreVertical, Trash2 } from 'lucide-react';
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
              {departments?.data?.length === 0 ? (
                ...
                departments?.data?.map((dept: any) => (
                  <tr key={dept.id} className="hover:bg-slate-50 dark:hover:bg-slate-950 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-slate-500">{dept.manager_name || 'No manager'}</div>
                        </div>
                      </div>
                    </td>
